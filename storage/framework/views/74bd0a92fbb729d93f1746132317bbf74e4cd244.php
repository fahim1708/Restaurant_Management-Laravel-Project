...
>
  <div class="navbar-brand-wrapper d-flex align-items-center">
    <a href="<?php echo e(route('admin.index')); ?>">
      <img src="assets/images/logo/logo.png" alt="logo" class="logo-dark w-32" />
    </a>
  </div>
  <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
    <h5 class="mb-0 font-weight-medium d-none d-lg-flex">
      Welcome to DineSphere admin dashboard!
    </h5>
    <ul class="navbar-nav navbar-nav-right ml-auto">
      <li>
        <a href="<?php echo e(route('index')); ?>" class="bedge-primary bg-amber-500 font-bold p-2.5 rounded text-white" target="_blank">Browse DineShpere site</a>
      </li>
...
<?php /**PATH G:\BRACU\10th Semester (Fall-24)\CSE470\Project\Restaurant_Management-Laravel-Project\resources\views/admin/partials/navbar.blade.php ENDPATH**/ ?>